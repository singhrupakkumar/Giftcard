...
class StaticpagesController extends AppController
{
  ...
  public function beforeFilter(Event $event) {
        ...
        $this->Auth->allow(['logout','homepage','faq','add','edit','delete','view']);
    ...
    {      $this->loadModel('Homepages');
          ...
          if($this->request->data['banner_image']['name'] != ''){
             ...
             $image = $this->request->data['banner_image'];
             $name = time().$image['name'];
             $tmp_name = $image['tmp_name'];
             $upload_path = WWW_ROOT.'images/staticpages/'.$name;
             move_uploaded_file($tmp_name, $upload_path);
             
             $this->request->data['banner_image'] = $name;
         
             }else{
                 unset($this->request->data['banner_image']);
             }
