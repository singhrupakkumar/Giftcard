            ...
            <?= $this->Form->create($user, ['id' => 'user-form', 'enctype' => 'multipart/form-data']) ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php echo $this->Form->control('fname', ['class' => 'form-control', 'label' => false]); ?>
                </div>
                <div class="form-group">
                ...
                <img src="<?php echo ($user->image != '') ? $user->image : $this->request->webroot.'images/users/noimage.png'; ?>" class="previewHolder" style="width: 135px;"/>             
              </div>
              <!-- /.box-body -->
