              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo $this->request->webroot; ?>admin/staticpages/delete/<?php echo $staticpage['id']; ?>" class="btn btn-danger btn-xs delt" onclick="if (confirm('Are you sure you want to delete this file?')) { return true; } return false;"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
